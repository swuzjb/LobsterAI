...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    agentWorkingDirectoryPlaceholder: '留空则使用 OpenClaw 默认工作区',
    agentWorkingDirectoryBrowse: '选择目录',
    agentSkills: '技能',
  ...
  en: {
    ...
    agentWorkingDirectory: 'Working Directory',
    agentWorkingDirectoryPlaceholder: 'Leave empty to use OpenClaw default workspace',
    agentWorkingDirectoryBrowse: 'Browse',
    agentSkills: 'Skills',
    agentSkillsHint:
