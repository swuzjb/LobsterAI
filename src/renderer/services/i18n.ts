...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkMemoryEmbeddingProviderHint: '选择 embedding 的运行方式：本地运行或自动选择',
    coworkMemoryEmbeddingProviderLocal: '本地',
    coworkMemoryEmbeddingProviderAuto: '自动',
  ...
  en: {
    ...
    coworkMemoryEmbeddingProviderHint: 'Choose how embeddings are computed: locally or auto-routed',
    coworkMemoryEmbeddingProviderLocal: 'Local',
    coworkMemoryEmbeddingProviderAuto: 'Auto',
