    ...
    theme: {
      extend: {
        colors: {
          ...
          'chat-user': {
            DEFAULT: 'var(--lobster-chat-user)',
            foreground: 'var(--lobster-chat-user-foreground)',
          },
          'chat-bot': {
            DEFAULT: 'var(--lobster-chat-bot)',
            foreground: 'var(--lobster-chat-bot-foreground)',
          },
          // Gradient tokens (for background meshes)
          'gradient-1': 'var(--lobster-gradient-1)',
          'gradient-2': 'var(--lobster-gradient-2)',
          border: {
